...
<head>
    ...
    @php $faviconStore = $store ?? (auth()->check() ? auth()->user()->store : null); @endphp
    @if($faviconStore && $faviconStore->logo_path)
        <link rel="icon" type="image/png" href="{{ $faviconStore->logo_url }}">
    @else
