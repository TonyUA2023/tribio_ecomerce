...
<section class="pt-28 pb-20 bg-white">
    <div class="container-tribio max-w-3xl">
        ...
        <div class="prose prose-slate prose-sm sm:prose-base max-w-none">
            ...
            <p>Algunas tiendas alojadas en Tribio usan el Píxel de Meta (Facebook e Instagram) para medir sus anuncios y mostrarte ofertas relevantes. En esas tiendas verás un aviso de cookies: el Píxel solo se activa si pulsas «Aceptar», y puedes rechazarlo sin que eso afecte tu compra. Si aceptas, la tienda puede comunicar a Meta los productos que ves, agregas al carrito o compras y, al completar un pedido, el correo, teléfono, nombre, ciudad y país del pedido cifrados de forma irreversible (hash), para que Meta relacione la compra con sus anuncios. Nunca se comparten tu documento de identidad ni tu dirección. Meta trata esa información conforme a su propia política de datos.</p>
