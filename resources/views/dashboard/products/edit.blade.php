            ...
            <div class="glass-card p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    ...
                    <div>
                        ...
                        <input type="number" name="price_usd" class="input-field border-green-500/30 focus:border-green-500" value="{{ old('price_usd', $product->price_usd) }}" step="0.01" min="0" placeholder="0.00">
                    </div>
                    <div>
                        <label class="input-label text-green-400">Precio anterior (USD $)</label>
                        <input type="number" name="compare_price_usd" class="input-field border-green-500/30 focus:border-green-500" value="{{ old('compare_price_usd', $product->compare_price_usd) }}" step="0.01" min="0" placeholder="0.00">
                    </div>
                </div>
